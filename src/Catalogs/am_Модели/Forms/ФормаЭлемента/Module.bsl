...
Процедура ИзменитьНаименованиеНаСервере()
	...
	Объект.Наименование = "" + Объект.Владелец + " " + Объект.СокрНаименование + ?(НЕ ЗначениеЗаполнено(Объект.Поколение), "", ", " + Объект.Поколение) + ?(НЕ ЗначениеЗаполнено(Объект.ГодВыпуска), "", ", " + Объект.ГодВыпуска);
